...
```mermaid
flowchart TD
    A[Scheduler / Manual run\n./scripts/run_report.sh] --> B[weekly_seo_agent/main.py\ncountry batch runner]
    B --> C[weekly_seo_agent/workflow.py\ncollect + analyze + reason]
    ...
    C --> E[weekly_seo_agent/reporting.py\nExecutive Summary + Narrative]
    E --> F[DOCX render\nwrite_docx]
    F --> G[Local file\noutputs + SEO Weekly Reports]

    G --> H[weekly_seo_agent/clients/google_drive_client.py\nupload_docx_as_google_doc]
